...
LogEntry getLogData() {
    ...
    logEntry.setFrametime({} /* TODO */);
    logEntry.setFramecounter({} /* TODO */);
    logEntry.setDroneConfig(getDroneConfiguration() /* TODO */);
    logEntry.setRcTuning(getRCTuner());
    logEntry.setRcThrottle(getRCThrottle());
    logEntry.setRcRoll(getRCRoll());
    logEntry.setRcPitch(getRCPitch());
    logEntry.setRcYaw(getRCYaw());
    logEntry.setReferenceOrientation(toCppArray(attitude.getReference()));
    logEntry.setReferenceHeight(altitude.getReference());
    logEntry.setReferenceLocation(toCppArray(position.getReference()));
    logEntry.setMeasurementOrientation({} /* TODO */);
    logEntry.setMeasurementAngularVelocity({} /* TODO */);
    logEntry.setMeasurementHeight({} /* TODO */);
    logEntry.setMeasurementLocation({} /* TODO */);
    ...
    logEntry.setAttitudeYawOffset({} /* TODO */);
